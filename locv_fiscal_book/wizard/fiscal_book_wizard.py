        ...
        for h in purchasebook_ids:
            ...
            if (partner.company_type == 'company' or  partner.company_type == 'person') and (partner.people_type_company or partner.people_type_individual) and  (partner.people_type_company == 'pjdo' or partner.people_type_individual == 'pnre' or  partner.people_type_individual == 'pnnr'):
                ...
                if h.invoice_id:
                    ...
                    sum_total_with_iva += h.invoice_id.amount_total   # Total monto con IVA
                ...
                if h.iwdl_id.invoice_id:
                    ...
                    sum_vat_additional_tax += h.vat_additional_tax  # IMPUESTO DE IVA ALICUOTA ADICIONAL
                    sum_total_with_iva += h.iwdl_id.invoice_id.amount_total  # Total monto con IVA
                    sum_vat_general_base += h.vat_general_base  # Base Imponible Alicuota general
                    sum_vat_general_tax += h.vat_general_tax  # Impuesto de IVA
                    h_vat_general_base = h.vat_general_base
                    h_vat_general_rate = int(
            ...
            elif partner.company_type == 'company' and partner.people_type_company and  partner.people_type_company == 'pjnd':
            ...
            if partner.people_type_company and  partner.people_type_company == 'pjnd' and h.vat_reduced_base != 0:
            ...
            if partner.people_type_company and  partner.people_type_company == 'pjnd' and h.vat_additional_base != 0:
            ...
            datos_compras.append({
                ...
                'vat_general_rate_importaciones' : str(vat_general_rate_importaciones) + ' ' + str(vat_reduced_rate_importaciones) + ' ' + str(vat_additional_rate_importaciones) + ' ',
